...
class _MoreOptionsState extends State<MoreOptions> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ? AppBar(
        elevation: 0,
        title: const Text("More Setting", style: TextStyle(color: Colors.white),),
        ...
        sections: [
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile(
                title: Text('Extract PDF', style: TextStyle(fontSize: 15),),
              ...
              SettingsTile(
                title: Text('Extract Excel File', style: TextStyle(fontSize: 15),),
          ...
          SettingsSection(
            ...
            tiles: [
              SettingsTile(title: Text('Phone number',  style: TextStyle(fontSize: 15),), leading: Icon(Icons.phone, size: 19,),
                onPressed: (context){
              ...
              SettingsTile(title: Text('Email',  style: TextStyle(fontSize: 15),), leading: Icon(Icons.email, size: 19,),
                onPressed: (context){
                  Navigator.of(context).push(
              ...
              SettingsTile(title: Text('Sign out',  style: TextStyle(fontSize: 15),), leading: Icon(Icons.exit_to_app, size: 19,),
                onPressed: (context) async {
          ...
          SettingsSection(
            title: Text('Secutiry', style: TextStyle(color: Colors.black),),
            tiles: [
          ...
          SettingsSection(
            title: Text('Misc', style: TextStyle(color: Colors.black),),
            tiles: [
              SettingsTile(
                  title: Text('Terms of Service', style: TextStyle(fontSize: 15),), leading: Icon(Icons.description, size: 19,),
                  onPressed: (context){},
              ),
              SettingsTile(
                  title: Text('Open source licenses', style: TextStyle(fontSize: 15),),
