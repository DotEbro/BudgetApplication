            ...
            children: [
              ...
              Container(
                ...
                child: SfCartesianChart(
                  title: ChartTitle(text: "Monthly Expense Analysis",),
                  tooltipBehavior: _tooltipBehavior,
              ...
              Padding(
                ...
                child: Row(
                  children: const [
                    ...
                    Spacer(),
                    Text("Date   ", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                  ...
                  child: widget.allTransaction.isEmpty
                      ...
                      : (flag
                      ? const Center(child: Text("No Transaction This Month"),)
                      :  ListView.builder(
                    shrinkWrap: true,
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              data.category == "" ? "Unassigned" : data.category,
